...
# get statistics for plotting maps and data
(highest_value, lowest_value, index_high_value, 
index_low_value, most_freespace, least_freespace, 
index_most_freespace, index_least_freespace, mean_value, mean_freespace) = getStatistics(moneyvalues, distances)
