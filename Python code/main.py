...
highest_value = max(valuelist)
index_high_value = valuelist.index(highest_value)

lowest_value = min(valuelist)
index_low_value = valuelist.index(lowest_value)

mean_value = sum(meanvaluelist) / len(meanvaluelist)

most_freespace = max(spacelist)
index_most_freespace = spacelist.index(most_freespace)

least_freespace = min(spacelist)
index_least_freespace = spacelist.index(least_freespace)

mean_freespace = sum(meanspacelist) / len(meanspacelist)
...
csv_writer(all_maps_val[index_high_value], pieces_of_water, houses_total, highest_value, name5)
csv_writer(all_maps_val[index_low_value], pieces_of_water, houses_total, lowest_value, name6)
csv_writer(all_maps_space[index_most_freespace], pieces_of_water, houses_total, most_freespace, name7)
csv_writer(all_maps_space[index_least_freespace], pieces_of_water, houses_total, least_freespace, name8)
